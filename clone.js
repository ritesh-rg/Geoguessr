...
function randomLoc(){
    ...
    if (index > world_city_set.length -1){
        index = 0
        //console.log(index)
        document.getElementById("totaldistance").innerHTML = 'Round Score: 5000'; 
        swal({
...
function display_location(){
    ...
    document.getElementById("totaldistance").innerHTML = "Round Score: " + Math.round(5000-0.42*accumulated_distance.toFixed(1));
}
